...
class CapybaDayTwentyThreeTestOutlineButton extends StatelessWidget {
  const CapybaDayTwentyThreeTestOutlineButton(
    this.text, {
    Key? key,
    this.onPressed,
                  ...
                  child: Row(
                    ...
                    children: [
                      Flexible(
                        child: Text(
                          text ?? '',
                          style: CapybaDayTwentyThreeTestTextStyle.button.style,
                ...
                Expanded(
                  ...
                  child: !isLoading
                      ...
                      : const Expanded(
                          ...
                          child: Center(
                            child:
                                CapybaDayTwentyThreeTestCircularProgressIndicator(),
                          ),
                        ),
                ),
              ],
